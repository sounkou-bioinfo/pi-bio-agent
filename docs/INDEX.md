...
- [Domain model](domain-model.md) — Read before adding any core type or domain pack — kernel slots, resources/CAS/resolvers, temporality, domain packs, and execution backends. _(domain-model, resources, resolvers, temporality, domain-packs, execution-backends)_
...
- [Resources and BioToolSpec](resources-and-tool-specs.md) — Read before defining resources, resolvers, or BioToolSpec/operation contracts. _(resources, cas, tool-spec, operation-spec)_
