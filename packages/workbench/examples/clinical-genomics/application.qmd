...
1. **ACMG evidence and class concordance.** [Ma et al.](https://doi.org/10.1126/scitranslmed.adz4172) describe
   ...
   Here `rule_development` means that the 1,000 curator-reviewed HKGP variants were used to optimize prompts and
   retrieval knowledge bases and then reassess seven literature-dependent rules. They are real variants, but they
   are development-contaminated rather than an independent evaluation set.
...
current clinical fixture tests substrate correctness, not model or clinical quality.
