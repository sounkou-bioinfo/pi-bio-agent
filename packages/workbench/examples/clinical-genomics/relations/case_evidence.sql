...
direct AS (
  SELECT
    ...
    va.vep_impact,
    va.vep_consequence,
    va.vep_allele_frequency,
    va.vep_clinical_significance,
    va.variant_bucket,
    va.variant_status,
...
inverted_without_support AS (
  SELECT
    ...
    NULL::VARCHAR AS vep_impact,
    NULL::VARCHAR AS vep_consequence,
    NULL::DOUBLE AS vep_allele_frequency,
    NULL::VARCHAR AS vep_clinical_significance,
