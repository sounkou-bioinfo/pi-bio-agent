...
direct AS (
  SELECT
    ...
    va.zygosity,
    va.inheritance,
    va.annotation_impact,
    va.annotation_consequence,
    va.annotation_allele_frequency,
    va.annotation_clinical_significance,
    va.variant_bucket,
    va.variant_status,
...
inverted_without_support AS (
  SELECT
    ...
    NULL::VARCHAR AS annotation_impact,
    NULL::VARCHAR AS annotation_consequence,
    NULL::DOUBLE AS annotation_allele_frequency,
    NULL::VARCHAR AS annotation_clinical_significance,
