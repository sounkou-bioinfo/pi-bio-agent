...
host through the SDK/CLI — **fail-closed by default**, so those powerful effects are granted deliberately, never
ambiently. So reproducible artifacts, connected databases, on-demand compute, and grounded review run on **your**
