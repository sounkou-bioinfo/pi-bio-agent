...
`node scripts/nng-survey.mjs` — the **survey** NNG topology
(surveyor/respondent) as a *multi-provider jury*, the provider-agnostic
creative use. One surveyor process broadcasts a question (“classify this
