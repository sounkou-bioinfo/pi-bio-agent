...
`scripts/blackboard-run.mjs` is a **pattern** of the **blackboard** (nng pub/sub) topology — **decentralized, no
...
(`live-multi-agent`) and survey (`live-debate`) patterns; only the topology differs. It is deterministic (canned
...
deterministic mechanics also back the chain/survey patterns — same executor, different scaffold.
