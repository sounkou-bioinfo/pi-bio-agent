...
`scripts/ducknng-fs.mjs` is a **pattern** (ridiculous-but-cool): a POSIX-shaped distributed file system built as a
...
**Dedup, snapshots, and provenance fall out for free.** This original pattern uses ducknng `exec` because it proves
