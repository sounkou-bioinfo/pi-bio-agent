---
title: "CAS bytes with SQL metadata over DuckNNG"
engine: pi-bio
format: gfm
---

This research pattern composes a mutable metadata tree served over DuckNNG RPC with immutable content-addressed
bytes. It exercises filesystem-like semantics without claiming a FUSE implementation or a production distributed
filesystem.
...
The example proves composability of mutable SQL metadata and immutable CAS bytes. FUSE, authorization policy,
remote CAS transport, crash recovery, and production filesystem semantics remain host/application work.
