...
This block is **generated by running the manifest through the substrate** (`npm run readme:coloc`) — literate
...
<!-- BEGIN GENERATED:coloc-run (npm run readme:coloc — do not edit by hand) -->
*Generated by `npm run readme:coloc` — the agent running the manifest (engine: `coloc::coloc.abf`).*
