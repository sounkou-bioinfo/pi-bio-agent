...
// frame parser here: parsing `data:` frames off a text/event-stream is a SEPARATE layer NOT yet in-tree; Pi's
// LLM streaming path is the reference shape for parser lifecycle. Bidirectional/push is wss over nng / ducknng.
// See docs/refinments.md "Streaming transports".
